...
class threadplugin_$plugin[identifier] {
	...
	public \$name = 'XX topic';			//Topic Type Name
	public \$iconfile = 'icon.gif';	//Post Topic link prefix icon
	public \$buttontext = 'Post xx theme';	//Post button text

	/**
	 * When the hair topic page new form items
	 * @param Integer \$fid: Forum ID
	 * @return string returned by the return can be output to the posting page
	 */
	...
	/**
	 * Analyzing data before topic Post
	 * @param Integer \$fid: Forum ID
	 */
...
$phptpl['magic'] = <<<EOF
class magic_{name} {
	public \$version = '$plugin[version]';	//Script version
	public \$name = '{name}';				//Props name (you can fill in the language pack item)
	public \$description = '{desc}';		//Props Description (fillable language pack item)
	public \$price = '20';	//Props default price
	public \$weight = '20';	//Props default weight
	public \$useevent = 0;
	public \$targetgroupperm = false;
	public \$copyright = '<a href="http://www.comsenz.com" target="_blank">Comsenz Inc.</a>';	//Copyright (fillable language pack item)
	public \$magic = array();
